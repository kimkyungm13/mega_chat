<div class="lnb" id="lnb">
    ...
    <div class="chat active">
        ...
        <div class="chat-history">
            <div class="chat-item active">
                <div class="chat-text">GPA 90점, 토익 800점이야. 경북대학교에 합격할 수 있을까? 합격할 수 있을까?</div>
                <button class="btn-more" aria-label="더보기"></button>
            </div>
            <div class="chat-item">
                <div class="chat-text">연세대 1단계 영어점수는 몇점인지 알수 있을까?</div>
                <button class="btn-more" aria-label="더보기"></button>
            </div>
            <div class="chat-item">
                <div class="chat-text">여기서 가장 많이 한 질문을 두 줄로 보여줘서 말줄임 되게 처리하는 작업을 했어</div>
                <button class="btn-more" aria-label="더보기"></button>
            </div>
            <div class="chat-item">
                <div class="chat-text">LEET 157점 지망 대학 추천</div>
                <button class="btn-more" aria-label="더보기"></button>
            </div>
            <div class="chat-item">
                <div class="chat-text">연세대 1단계 영어점수는?</div>
                <button class="btn-more" aria-label="더보기"></button>
            </div>
            <div class="chat-item fixed" aria-label="더보기">
                <div class="chat-text">2025학년도 경북대학교 로스쿨</div>
                <button class="btn-more" aria-label="더보기"></button>
            </div>
            <div class="chat-item">
                <div class="chat-text">연세대 1단계 영어점수는?</div>
            ...
            <div class="chat-item">
                <div class="chat-text">여기서 가장 많이 한 질문</div>
                <button class="btn-more" aria-label="더보기"></button>
            </div>
            <div class="chat-item">
                <div class="chat-text">LEET 157점 지망 대학 추천</div>
    ...
    <button class="btn-chat hide-chat-btn" type="button" onclick="location.href=''">
