<div class="input-container ">
    ...
    <div class="message-wrap">
        <button class="btn-scroll" data-role="scroll-page" aria-label="하단으로">
            <img src="http://img.megals.co.kr/mega_chat/btn_arrow.png" alt="">
        </button>
        <textarea name="" class="message-input" id="messageInput"></textarea>
        <button class="send-btn loading" id="sendBtn" type="button">
        </button>
        <div class="custom-placeholder">
            <strong class="highlight">질문 TIP</strong> LEET 점수, GPA 점수, 토익 점수를 함께 입력하면 보다 정확한 정보를 확인할 수 있어요!
        </div>
    ...
    <div class="info-wrap">
        ...
        <!--25.07.21-->
        <ul class="input-info">
            <li>메가로스쿨 AI 디케이는 AI 서비스 특성상 답변이 불가능하거나, 데이터에 오류가 발생하는 경우가 있을 수 있습니다.</li>
            <li>합격자 데이터의 경우 실제 입시 결과와는 차이가 있을 수 있으니 참고용으로 활용하시기 바랍니다.
                <a href="pop.html" class="btn-text-line"
                    onclick="window.open( this.href , '_blank' , ' width=750 , height=800, top=50 , left=50 , scrollbars=yes, toolbar=no, menubar=no, resizable=no, copyhistory=no' ); return false">이용안내
                    전문보기
                </a>
